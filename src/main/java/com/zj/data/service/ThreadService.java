...
public class ThreadService implements Runnable{
	...
	public ThreadService(List<String> list,int start, int end) {
		this.list = list;
		this.start = start;
		this.end = end;
	}
...
//				 String period = periodE.text();
		   	 ...
		   	 Element downloadE = document.select("div[class=down des]").get(0);
...
//					String content = price + "\t" + txt + "\r\n";
		  	...
		  	content.append(download + "\t" + title + "	" + time + "	" + price +"\t"+txt+ "\t" + i + "\r\n");
...
//			   		completeNum ++;
	...
	public static void setCompleteNum(int completeNum) {
		ThreadService.completeNum = completeNum;
	}
